...
//===========
function parseBarsKeepEmpty(input) {
...
function buildExportRhythm(
    ...
    bars.forEach(bar => {
        ...
        if (noteCount > grid) {
            ...
            throw new Error(
                `음표 개수(${noteCount})가 Grid(${grid})보다 많습니다.`
            );
        }
